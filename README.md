...
The production model is **LightGBM 53-feature** (`lean_lgbm_53feat_model.joblib`).  
A stricter variant **min5** (`lean_lgbm_53feat_min5_model.joblib`) is also available and togglable via the UI.

| Metric | Standard | Min5 |
|--------|----------|------|
| MAE    | ~4.1 dB  | ~4.3 dB |
| RMSE   | ~5.8 dB  | ~5.9 dB |
| R²     | ~0.62    | ~0.61 |
